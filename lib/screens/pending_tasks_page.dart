                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  _buildStatLabel('Pending', taskProvider.pendingCount.toString()),
                                  _buildStatLabel('Completed', taskProvider.completedCount.toString()),
                                  _buildStatLabel('Total', taskProvider.totalTasks.toString()),
                                ],
                              ),
                              const SizedBox(height: 18),
